...
{
    // dsv = Domain Service
    public class dsvCADENDEREC : ServiceBase<TBCADENDEREC>, disCADENDEREC
    {
        private readonly dirCADENDEREC _dirCADENDEREC;

        public dsvCADENDEREC(dirCADENDEREC objCADENDEREC)
            : base(objCADENDEREC)
        {
            _dirCADENDEREC = objCADENDEREC;
        }
    }
}
